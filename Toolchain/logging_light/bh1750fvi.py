#   Copyright 2020 Kasper Schultz Davidsen
#
...
#
#   This file has been modified by Kasper Schultz Davidsen to use utime
#   rather than time.
...
def sample(i2c, mode=OP_SINGLE_HRES1, i2c_addr=0x23):
    ...
    utime.sleep_ms(DELAY_LMODE if mode == OP_SINGLE_LRES else DELAY_HMODE)
